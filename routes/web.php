...
Route::resource('projets', ProjetController::class)->only(['index', 'create', 'store', 'edit', 'update', 'destroy']);
Route::get('projets/{id}/gerer', [ProjetController::class, 'gerer'])->name('projets.gerer');
Route::get('projets/{id}/select', [ProjetController::class, 'selectProject'])->name('projets.select');
Route::get('projets/{projetId}/sites', [ProjetController::class, 'sites'])->name('projets.sites');
...
Route::post('projets/{projetId}/services', [ServiceController::class, 'store'])->name('services.store');
Route::get('projets/{projetId}/services/{id}/edit', [ServiceController::class, 'edit'])->name('services.edit');
Route::put('projets/{projetId}/services/{id}', [ServiceController::class, 'update'])->name('services.update');
Route::delete('projets/{projetId}/services/{id}', [ServiceController::class, 'destroy'])->name('services.destroy');
...
Route::get('projets/{projetId}/ouvriers', [OuvrierController::class, 'index'])->name('ouvriers.index');
Route::get('projets/{projetId}/ouvriers/create', [OuvrierController::class, 'create'])->name('ouvriers.create');
Route::post('projets/{projetId}/ouvriers', [OuvrierController::class, 'store'])->name('ouvriers.store');
Route::get('projets/{projetId}/ouvriers/{id}/edit', [OuvrierController::class, 'edit'])->name('ouvriers.edit');
Route::put('projets/{projetId}/ouvriers/{id}', [OuvrierController::class, 'update'])->name('ouvriers.update');
Route::delete('projets/{projetId}/ouvriers/{id}', [OuvrierController::class, 'destroy'])->name('ouvriers.destroy');

Route::get('projets/{projetId}/ressources', [RessourceController::class, 'index'])->name('ressources.index');
Route::get('projets/{projetId}/ressources/create', [RessourceController::class, 'create'])->name('ressources.create');
Route::post('projets/{projetId}/ressources', [RessourceController::class, 'store'])->name('ressources.store');
Route::get('projets/{projetId}/ressources/{id}/edit', [RessourceController::class, 'edit'])->name('ressources.edit');
Route::put('projets/{projetId}/ressources/{id}', [RessourceController::class, 'update'])->name('ressources.update');
Route::delete('projets/{projetId}/ressources/{id}', [RessourceController::class, 'destroy'])->name('ressources.destroy');

Route::get('projets/{projetId}/operations', [OperationController::class, 'index'])->name('operations.index');
Route::get('projets/{projetId}/operations/create', [OperationController::class, 'create'])->name('operations.create');
Route::post('projets/{projetId}/operations', [OperationController::class, 'store'])->name('operations.store');
Route::get('projets/{projetId}/operations/{id}/edit', [OperationController::class, 'edit'])->name('operations.edit');
Route::put('projets/{projetId}/operations/{id}', [OperationController::class, 'update'])->name('operations.update');
Route::delete('projets/{projetId}/operations/{id}', [OperationController::class, 'destroy'])->name('operations.destroy');

...
@section('content')
    <div class="container">
            ...
            <tbody>
                @foreach ($projets as $projet)
                    <tr>
                        ...
                        <td>
                            <button class="btn btn-warning editProjetBtn" data-id="{{ $projet->id }}"
                                data-nom="{{ $projet->nomProjet }}" data-debut="{{ $projet->dateDebut }}"
                                data-fin="{{ $projet->dateFin }}">Modifier</button>
        ...
        <!-- Create Projet Modal -->
        <div class="modal fade" id="createProjetModal" tabindex="-1" role="dialog"
            aria-labelledby="createProjetModalLabel" aria-hidden="true">
        ...
        <!-- Delete Projet Modal -->
        <div class="modal fade" id="deleteProjetModal" tabindex="-1" role="dialog"
            aria-labelledby="deleteProjetModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
